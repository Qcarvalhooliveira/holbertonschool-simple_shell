...
/**
 * parse_command - Function that determines the type of the command
...
/**
 * execute_command - Function that executes a command based on it's type
 ...
 *
 * Return: To the path that the command was founded in, NULL if not found
 */
...
/**
 * get_func - Returns a function based on the provided command and a mapping.
